...
def substrate_excel_creation(response_data: dict, info_data: dict, excel_name: str):
    ...
    main_bold = workbook.add_format({'bold': True, 'center_across': False, 'border': True})
    ...
    worksheet.merge_range("A12:J12", 
                          ...
                          workbook.add_format({'italic': True, 'center_across': False, 'border': False}))
    
    worksheet.merge_range("A13:D13", "Segment One", bold)
    worksheet.merge_range("E13:H13", "Segment Two", bold)
    worksheet.merge_range("I13:L13", "Segment Three", bold)
    worksheet.merge_range("M13:P13", "Segment Four", bold)


    # distances
    worksheet.merge_range("A14:D14", "0 - 19.5m", bold)
    worksheet.merge_range("E14:H14", "25 - 44.5m", bold)
    worksheet.merge_range("I14:L14", "50 - 69.5m", bold)
    worksheet.merge_range("M14:P14", "75 - 94.5", bold)
